...
import Aesthetic_SupplierReturnDialog from '../../components/aesthetic/aesthetic_SupplierReturnDialog'
...
export default function Pharmacy_SupplierReturns() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        const res: any = await aestheticApi.listPurchases({ from: from || undefined, to: to || undefined, search: (invoice || supplier) || undefined, page, limit })
  ...
  return (
    <div className="space-y-4">
      ...
      <Aesthetic_SupplierReturnDialog
        open={!!selected}
