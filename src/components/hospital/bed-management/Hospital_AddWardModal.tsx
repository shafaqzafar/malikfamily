...
export default function Hospital_AddWardModal({ open, onClose, floors, onSave }: { open: boolean; onClose: () => void; floors: FloorRef[]; onSave: (data: { floorId: string; name: string }) => void }) {
  ...
  return (
    <Hospital_Modal open={open} onClose={onClose}>
      <div className="px-1">
        <div className="text-lg font-semibold text-slate-800">Add Ward</div>
