...
export default function Aesthetic_SupplierReturnDialog({ open, onClose, purchase, onSubmitted }: Props){
  ...
  async function submit(){
    ...
    try {
      ...
      try { window.dispatchEvent(new CustomEvent('aesthetic:return', { detail: { reference: purchase.invoice } })) } catch {}
    } catch (err: any) {
