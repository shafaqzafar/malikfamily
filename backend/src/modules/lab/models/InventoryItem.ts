...
}, { timestamps: true, collection: 'lab_inventoryitems' })

export type LabInventoryItemDoc = {
  _id: string
  key: string
  name: string
  genericName?: string
...
export const LabInventoryItem = models.Lab_InventoryItem || model('Lab_InventoryItem', InventoryItemSchema)
