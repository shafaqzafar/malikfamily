...
IpdVitalSchema.index({ encounterId: 1, recordedAt: -1 })

export type HospitalIpdVitalDoc = {
  _id: string
  patientId: string
  encounterId: string
  recordedAt: Date
...
export const HospitalIpdVital = models.Hospital_IpdVital || model('Hospital_IpdVital', IpdVitalSchema)
