...
}, { timestamps: true, collection: 'aesthetic_purchasedrafts' })
...
export const PurchaseDraft = models.Aesthetic_PurchaseDraft || model('Aesthetic_PurchaseDraft', PurchaseDraftSchema)
